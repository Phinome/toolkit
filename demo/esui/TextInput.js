...
esui.TextInput = function ( options ) {
    ...
    // 初始化value fix bug by acelan
    this.value = esui.util.hasValue(this.value) ? this.value : '';
...
esui.TextInput.prototype = {
    ...
    setValue: function ( value ) {
        value = esui.util.hasValue(value) ? value : '';
    ...
    __construct: function () {
        ...
        //fix bug by acelan
        me.value = esui.util.hasValue(me.value) ? me.value : main.value;
