 ...
 * @returns {XMLHttpRequest} 	发送请求的XMLHttpRequest对象
 */
baidu.ajax.post = function(url, data, onsuccess, async) {
...
/* IGNORE API: baidu.data.DataModel */

/* IGNORE API: baidu.data.DataStore */

/* IGNORE API: baidu.data.Field */

/* IGNORE API: baidu.data.ModelManager */

/* IGNORE API: baidu.data.Validator */

/* IGNORE API: baidu.data.Validator.validatorRules */

/* IGNORE API: baidu.data.XPC */

/* IGNORE API: baidu.data.dataSource.DataSource */

/* IGNORE API: baidu.data.dataSource.ajax */

/* IGNORE API: baidu.data.dataSource.local */

/* IGNORE API: baidu.data.dataSource.sio */

/* IGNORE API: baidu.data.storage */

/* IGNORE API: baidu.flash.avatarMaker */

/* IGNORE API: baidu.flash.fileUploader */

/* IGNORE API: baidu.flash.imageUploader */
/**
...
baidu.form.ValidRule = baidu.form.ValidRule || baidu.lang.createClass(function(){
    ...
    me._rules = {
        ...
        maxlength: function(val, opt){
            return T.string.getByteLength(val) <= opt;
        },
...
baidu.object.extend(baidu.form.Validator.prototype,
     ...
     */
    {
        ...
        _getContentElement: function(field) {
            ...
            if (!element) {
                /**高钰东因需求而修改*/
                if (container) {
                    container.innerHTML = baidu.string.format(me.tplDOM, {
                        id: rsid,
    ...
    /* IGNORE API: baidu.fx.Timeline */

    /* IGNORE API: baidu.fx.collapse */

    /* IGNORE API: baidu.fx.create */

    /* IGNORE API: baidu.fx.current */

    /* IGNORE API: baidu.fx.expand */

    /* IGNORE API: baidu.fx.fadeIn */

    /* IGNORE API: baidu.fx.fadeOut */

    /* IGNORE API: baidu.fx.getTransition */

    /* IGNORE API: baidu.fx.highlight */

    /* IGNORE API: baidu.fx.mask */

    /* IGNORE API: baidu.fx.move */

    /* IGNORE API: baidu.fx.moveBy */

    /* IGNORE API: baidu.fx.moveTo */

    /* IGNORE API: baidu.fx.opacity */

    /* IGNORE API: baidu.fx.puff */

    /* IGNORE API: baidu.fx.pulsate */

    /* IGNORE API: baidu.fx.remove */

    /* IGNORE API: baidu.fx.scale */

    /* IGNORE API: baidu.fx.scrollBy */

    /* IGNORE API: baidu.fx.scrollTo */

    /* IGNORE API: baidu.fx.shake */

    /* IGNORE API: baidu.fx.zoomIn */

    /* IGNORE API: baidu.fx.zoomOut */

    /* IGNORE API: baidu.history.listen */

    /* IGNORE API: baidu.i18n.cultures.en-US */

    /* IGNORE API: baidu.i18n.cultures.zh-CN */

    /* IGNORE API: baidu.i18n.currency */

    /* IGNORE API: baidu.i18n.date */

    /* IGNORE API: baidu.i18n.number */

    /* IGNORE API: baidu.i18n.string */

    /* IGNORE API: baidu.parser.Json */

    /* IGNORE API: baidu.parser.Parser */

    /* IGNORE API: baidu.parser.Xml */

    /* IGNORE API: baidu.parser.create */

    /* IGNORE API: baidu.parser.type */

    /* IGNORE API: baidu.tools.log */

    /* IGNORE API: baidu.tools.log.Dialog */

    /* IGNORE API: baidu.ui.Accordion */

    /* IGNORE API: baidu.ui.Accordion.Accordion$fx */

    /* IGNORE API: baidu.ui.Base */

    /* IGNORE API: baidu.ui.Base.getParent */

    /* IGNORE API: baidu.ui.Base.setParent */

    /* IGNORE API: baidu.ui.Button */

    /* IGNORE API: baidu.ui.Button.Button$capture */

    /* IGNORE API: baidu.ui.Button.Button$poll */

    /* IGNORE API: baidu.ui.Calendar */

    /* IGNORE API: baidu.ui.Carousel */

    /* IGNORE API: baidu.ui.Carousel.Carousel$autoScroll */

    /* IGNORE API: baidu.ui.Carousel.Carousel$btn */

    /* IGNORE API: baidu.ui.Carousel.Carousel$cycle */

    /* IGNORE API: baidu.ui.Carousel.Carousel$fx */

    /* IGNORE API: baidu.ui.Carousel.Carousel$splice */

    /* IGNORE API: baidu.ui.Carousel.Carousel$table */

    /* IGNORE API: baidu.ui.ColorPalette */

    /* IGNORE API: baidu.ui.ColorPicker */

    /* IGNORE API: baidu.ui.ColorPicker.ColorPicker$click */

    /* IGNORE API: baidu.ui.ColorPicker.ColorPicker$more */

    /* IGNORE API: baidu.ui.Combox */

    /* IGNORE API: baidu.ui.Combox.Combox$select */

    /* IGNORE API: baidu.ui.Combox.Combox$statable */

    /* IGNORE API: baidu.ui.DatePicker */

    /* IGNORE API: baidu.ui.Decorator */

    /* IGNORE API: baidu.ui.Dialog */

    /* IGNORE API: baidu.ui.Dialog.Dialog$autoDispose */

    /* IGNORE API: baidu.ui.Dialog.Dialog$button */

    /* IGNORE API: baidu.ui.Dialog.Dialog$closeButton */

    /* IGNORE API: baidu.ui.Dialog.Dialog$coverable */

    /* IGNORE API: baidu.ui.Dialog.Dialog$draggable */

    /* IGNORE API: baidu.ui.Dialog.Dialog$iframe */

    /* IGNORE API: baidu.ui.Dialog.Dialog$keyboard */

    /* IGNORE API: baidu.ui.Dialog.Dialog$modal */

    /* IGNORE API: baidu.ui.Dialog.Dialog$resizable */

    /* IGNORE API: baidu.ui.Input */

    /* IGNORE API: baidu.ui.ItemSet */

    /* IGNORE API: baidu.ui.Login */

    /* IGNORE API: baidu.ui.Login.Login$register */

    /* IGNORE API: baidu.ui.Menubar */

    /* IGNORE API: baidu.ui.Menubar.Menubar$click */

    /* IGNORE API: baidu.ui.Menubar.Menubar$fx */

    /* IGNORE API: baidu.ui.Menubar.Menubar$hover */

    /* IGNORE API: baidu.ui.Menubar.Menubar$icon */

    /* IGNORE API: baidu.ui.Modal */

    /* IGNORE API: baidu.ui.Modal.Modal$coverable */

    /* IGNORE API: baidu.ui.Pager */

    /* IGNORE API: baidu.ui.Popup */

    /* IGNORE API: baidu.ui.Popup.Popup$coverable */

    /* IGNORE API: baidu.ui.ProgressBar */

    /* IGNORE API: baidu.ui.ScrollBar */

    /* IGNORE API: baidu.ui.ScrollBar.ScrollBar$container */

    /* IGNORE API: baidu.ui.ScrollPanel */

    /* IGNORE API: baidu.ui.ScrollPanel.ScrollPanel$adaptive */

    /* IGNORE API: baidu.ui.Slider */

    /* IGNORE API: baidu.ui.Slider.Slider$progressBar */

    /* IGNORE API: baidu.ui.StarRate */

    /* IGNORE API: baidu.ui.Suggestion */

    /* IGNORE API: baidu.ui.Suggestion.Suggestion$coverable */

    /* IGNORE API: baidu.ui.Suggestion.Suggestion$data */

    /* IGNORE API: baidu.ui.Suggestion.Suggestion$fixWidth */

    /* IGNORE API: baidu.ui.Suggestion.Suggestion$input */

    /* IGNORE API: baidu.ui.Tab */

    /* IGNORE API: baidu.ui.Table */

    /* IGNORE API: baidu.ui.Table.Table$btn */

    /* IGNORE API: baidu.ui.Table.Table$edit */

    /* IGNORE API: baidu.ui.Table.Table$page */

    /* IGNORE API: baidu.ui.Table.Table$select */

    /* IGNORE API: baidu.ui.Table.Table$title */

    /* IGNORE API: baidu.ui.Toolbar */

    /* IGNORE API: baidu.ui.Toolbar.Separator */

    /* IGNORE API: baidu.ui.Toolbar.Spacer */

    /* IGNORE API: baidu.ui.Tooltip */

    /* IGNORE API: baidu.ui.Tooltip.Tooltip$click */

    /* IGNORE API: baidu.ui.Tooltip.Tooltip$close */

    /* IGNORE API: baidu.ui.Tooltip.Tooltip$fx */

    /* IGNORE API: baidu.ui.Tooltip.Tooltip$hover */

    /* IGNORE API: baidu.ui.Tree */

    /* IGNORE API: baidu.ui.behavior.coverable */

    /* IGNORE API: baidu.ui.behavior.decorator */

    /* IGNORE API: baidu.ui.behavior.draggable */

    /* IGNORE API: baidu.ui.behavior.droppable */

    /* IGNORE API: baidu.ui.behavior.posable.setPositionByElement */

    /* IGNORE API: baidu.ui.behavior.posable.setPositionByMouse */

    /* IGNORE API: baidu.ui.behavior.resizable */

    /* IGNORE API: baidu.ui.behavior.sortable */

    /* IGNORE API: baidu.ui.behavior.statable.setStateHandler */

    /* IGNORE API: baidu.ui.create */

    /* IGNORE API: baidu.ui.createPopup */

    /* IGNORE API: baidu.ui.createUI */

    /* IGNORE API: baidu.ui.get */

    /* IGNORE API: baidu.ui.getAttribute */

    /* IGNORE API: baidu.ui.getUI */

    /* IGNORE API: baidu.widget.create */

    /* IGNORE API: baidu.widget.dispose */

    /* IGNORE API: baidu.widget.get */

    /* IGNORE API: baidu.widget.getPath */

    /* IGNORE API: baidu.widget.load */;      T.undope=true;